...
> **Note:** Expansion panels are documented in the Material Design documentation under [Lists](https://material.io/design/components/lists.html) instead of their own page now.
